						...
						%>
								...
								<div>
									<div>
										...
										<a href="profile.jsp"><img src="images/potf1.jpg" width="40px" height="40px " alt="errorprofile"></a>
										<div>

											<label style="color: white;"> 
								  <%
									 out.print("welcome : your email is :-" + session.getAttribute("email"));
									 out.print("<br>");
									 out.print("Your Mobile Number is:-" + session.getAttribute("mobile"));
									 out.print("<br>");
               ...
               <div class="row">
                  ...
                  <div class="col-md-3 col-sm-5 d_none">
                     ...
                     %>
                        ...
                        <a class="swd-button" href="login.jsp">sign in </a>
